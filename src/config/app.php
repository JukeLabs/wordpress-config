...
if ( file_exists($env_config = $root . '/config/envs/' . WP_ENV . '.php') ) {
  require_once($env_config);
} else {
  if ( file_exists($env_config = __DIR__ . '/envs/' . WP_ENV . '.php') ) {
    require_once($env_config);
  }
}
 ...
 */
define('CONTENT_DIR', env('CONTENT_DIR') !== null ? env('CONTENT_DIR') : '/content');
